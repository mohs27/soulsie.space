/*
    _____ _____  ______ _____ _____ _______ _____    _____ _               _____ __  __ _ 
  / ____|  __ \|  ____|  __ \_   _|__   __/ ____|  / ____| |        /\   |_   _|  \/  | |
 | |    | |__) | |__  | |  | || |    | | | (___   | |    | |       /  \    | | | \  / | |
 | |    |  _  /|  __| | |  | || |    | |  \___ \  | |    | |      / /\ \   | | | |\/| | |
 | |____| | \ \| |____| |__| || |_   | |  ____) | | |____| |____ / ____ \ _| |_| |  | |_|
  \_____|_|  \_\______|_____/_____|  |_| |_____/   \_____|______/_/    \_\_____|_|  |_(_)
  * Current source is made by https://github.com/soulsie
  * License: MIT
    - Notes:
 */
// open sourced because its outdated and server is down anyways
(function () {
    ...
    form.prototype.submitHandler = function (values) {
      ...
      // atm server is outdated so it will always throw errors
    ...
    new form("contact", {
      ...
      hid: "url",
      recaptcha: {
        key: "6Le5XIgnAAAAAEUarb_6pgNSNTWBl4k6uJa_SLQs",
        darkMode: true,
      },
      success: {
        mode: 1,
        value: "Email was sent successfully",
      },
    });
